...
public interface ApiService {
    ...
    ApiEntity createFromSwagger(UpdateApiEntity api, String userId, ImportSwaggerDescriptorEntity swaggerDescriptor);

    ApiEntity update(String apiId, UpdateApiEntity api);
    ApiEntity updateFromSwagger(String apiId, UpdateApiEntity swaggerApiEntity, ImportSwaggerDescriptorEntity swaggerDescriptor);
