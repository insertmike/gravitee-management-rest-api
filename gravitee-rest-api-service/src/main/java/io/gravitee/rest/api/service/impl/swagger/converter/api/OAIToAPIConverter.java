 ...
 */
public class OAIToAPIConverter implements SwaggerToApiConverter<OAIDescriptor>, OAIDescriptorVisitor<UpdateApiEntity> {
    ...
    @Override
    public UpdateApiEntity convert(OAIDescriptor descriptor) {
    ...
    @Override
    public UpdateApiEntity visit(OpenAPI oai) {
        final UpdateApiEntity apiEntity = new UpdateApiEntity();
