...
public class ApisResource extends AbstractResource {
    ...
    public Response importSwagger(
        ...
        final UpdateApiEntity updateApiEntity = swaggerService.createAPI(swaggerDescriptor);
        final ApiEntity api = apiService.createFromSwagger(updateApiEntity, getAuthenticatedUser(), swaggerDescriptor);
        return Response
